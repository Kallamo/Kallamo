...
ipcMain.handle('get-settings', async () => {
  try {
    ...
    const defaultSettings = {
      ...
      advanced: { chunkSize: 500, similarity: 0.3, topKKB: 5, topKMemory: 8, executionDevice: 'cpu', ragDebug: false, agenticDebug: false, tokenDebug: false, archiveSummarization: true, systemOutputLanguage: 'English', taggerMode: 'inherit-system', summarizerMode: 'inherit-system', retrievalPlannerMode: 'profile', agenticGate: 'auto', agenticToolProtocol: 'auto' }
    };
