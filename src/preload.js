...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  getWritingDeskConfig: (workspaceId) => ipcRenderer.invoke('get-writing-desk-config', { workspaceId }),
  saveWritingDeskConfig: (workspaceId, config) => ipcRenderer.invoke('save-writing-desk-config', { workspaceId, config }),
  ...
  importDocument: (workspaceId, folderId, defaults) => ipcRenderer.invoke('import-document', { workspaceId, folderId, defaults }),
